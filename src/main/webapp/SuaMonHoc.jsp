...
<body>
	<form action="SuaMonHoc_servlet" method="post" onsubmit="return validateInput()">
        <label for="maMH">Mã môn học : <%= request.getParameter("maMH") %></label>
        <input id="maMH" name="maMH" type="hidden" value="<%= request.getParameter("maMH") %>"><br>
